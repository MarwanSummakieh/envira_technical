...
## What I built
- Built a single-asset exposure API and shared CLI, startup validation, projected station assignment and exact rainfall totals.
...
- No frontend, portfolio, database, shared cache or deployment; chose CLI because Docker's daemon was unavailable.
